...
const InvoiceRecord = ({ data }) => {
  ...
  return (
    <div className=" shadow-md  flex flex-col justify-between w-full font-sans md:mx-3 font-sans p-8 bg-white ">
      <div>
          ...
          <div className="flex flex-col gap-2">
            <table className="w-full border-collapse border border-gray-300 text-sm text-right  ">
              <tbody className="">
                ...
                <tr>
                  <th className=" px-4 py-2 bg-gray-100 text-gray-700">
                    Total
                  </th>
      ...
      {/* Footer */}
      <div className="mt-3 flex flex-col gap-4 border-t justify-center text-center text-black text-xs">
        <p className="">
